...
SHORT_DESCRIPTION = (
    ...
    "analyze, score, and risk-check investment ideas — for paper research only."
)
DISCLAIMER = (
    "Paper / research only. Not financial advice. Demo and simulated scores "
    "do not predict future results. This project does not handle real money, "
